      ...
      return {
        ...
        compile: function(m, n) {
          ...
          return ["ng-repeat", "data-ng-repeat", "ng:repeat", "x-ng-repeat"].every(function(a) {
            ...
            function(m, o, q, r) {
              function u() {
                for (var a = o[0].childNodes, b = [], c = 0; c < a.length; c++) "LI" === a[c].tagName && b.push(a[c]);
                return b
              }
              ...
              if (m.carouselIndex = 0, s || (P = [], angular.forEach(u(), function(a, b) {
                ...
                var V = (s ? m.$eval(p.replace("::", "")).length : P.length) > 1 ? angular.isDefined(n.rnCarouselControlsAllowLoop) : !1,
                  ...
                  var carouselIconPrev = "";
                  var carouselIconNext = "";
                  if(void 0 !== q.rnCarouselIconStyle2){
                    carouselIconPrev = '<md-icon class="material-icon icon-size-small">arrow_back</md-icon>';
                    carouselIconNext = '<md-icon class="material-icon icon-size-small">arrow_forward</md-icon>';
                  }
                  else{
                    //Default icon style
                    carouselIconPrev = '<md-icon class="material-icon icon-size-small">chevron_left</md-icon>';
                    carouselIconNext = '<md-icon class="material-icon icon-size-small">chevron_right</md-icon>';
                  }
                  console.log();
                  X = '<div class="rn-carousel-controls">\n  <span class="rn-carousel-control rn-carousel-control-prev" ng-click="prevSlide()" ng-if="carouselIndex > 0 || ' + V + '">'+carouselIconPrev+'</span>\n  <span class="rn-carousel-control rn-carousel-control-next" ng-click="nextSlide()" ng-if="carouselIndex < ' + W + " || " + V + '">'+carouselIconNext+'</span>\n</div>';
